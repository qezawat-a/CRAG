...
2. User says "buy 0.1 ETH" â†’ 0.1 / 0.01 = **10 contracts**; user says "open a 500 USDT position" â†’ first look up the current price to convert to coin quantity, then divide by the face value.
...
## âš ï¸ Safety Confirmation (mandatory)
